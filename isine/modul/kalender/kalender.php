...
$JUDULCAL = array ();
    ...
    $cekdate = mysql_query ("SELECT `judul`,`waktu_mulai`,`waktu_akhir`,`isi` FROM kalender WHERE `waktu_mulai` = '$varwaktucalender' OR `waktu_akhir` = '$varwaktucalender2' ORDER BY `waktu_mulai`");
