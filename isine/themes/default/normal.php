...
# Berita
$hasil = $koneksi_db->sql_query("SELECT * FROM berita WHERE publikasi=1 ORDER BY tanggal DESC LIMIT 10");	
...
$no = 1;
$s = $koneksi_db->sql_query("SELECT * FROM foto ORDER BY id DESC LIMIT 12");	
