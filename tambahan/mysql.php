...
$koneksi_crot = new sql_db($mysql_host, $mysql_user, $mysql_password, $mysql_database, false);
if (!$koneksi_crot->db_connect_id) {
die('<div style="background:#FFE9E9; border:1px solid #FFC5C5; padding:10px; font-family:Arial, Helvetica, sans-serif; color:red;"><strong>Critical Error</strong><br>Could not connect to the database</div>');
}
